...
This script automates the process of collecting meeting summaries and full transcripts from your Granola account and appending them to your Craft.do Daily Notes for the **previous day**.

## How it works

1. Fetches all meetings created on the **previous day** (yesterday) from Granola.
...
4. Appends it to your Craft.do **Daily Note for yesterday**.
